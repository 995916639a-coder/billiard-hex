document.addEventListener('DOMContentLoaded', () => {
    ...
    const allCards = [
        ...
        { id: 7, name: "利滚利", description: "若接下来5个回合后，你的场上球比对方少，则获得2次自由球", tier: "silver" },
        { id: 8, name: "摆烂", description: "若接下来4个回合后，你的场上球比对方多，则获得2次自由球", tier: "silver" },
        ...
        // 棱彩阶
        { id: 28, name: "预见未来", description: "本局对手必须提前告知下回合打哪颗球，若没做到，则算犯规", tier: "prismatic" },
        { id: 29, name: "片叶不沾身", description: "本局击打白球碰四边库且不触碰任何球，成功获得自由球并可循环发动，碰到其他球则犯规，但你的空杆不算犯规", tier: "prismatic" },
        { id: 30, name: "翻袋宣言", description: "本局只要宣布本杆打翻袋成功进球，成功获得自由球", tier: "prismatic" },
        { id: 31, name: "接二连三", description: "本局只要宣布本杆连进2球，成功额外获得1次击球", tier: "prismatic" },
