document.addEventListener('DOMContentLoaded', () => {
    ...
    const allCards = [
        ...
        { id: 38, name: "片叶不沾身", description: "（全局可用）使用前说明自己本杆挑战“片叶不沾身”，若此球碰到四边库且没有碰到任何球，则获得2次自由球，（此球空杆不算犯规，但若过程中碰撞到对方球，则对方获得1次自由球）", tier: "prismatic" },
        ...
        { id: 43, name: "利滚利++", description: "进行判定：若此刻你的场上球比对方少，则获得1次自由球", tier: "prismatic" },
        { id: 44, name: "摆烂王++", description: "进行判定：若此刻你的场上球比对方多，则获得1次自由球", tier: "prismatic" },
