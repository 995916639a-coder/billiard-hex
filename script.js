document.addEventListener('DOMContentLoaded', () => {
    ...
    const allCards = [
        ...
        { id: 29, name: "铁索连环", description: "选择对手一颗球绑定，本杆若你进球则该球你放在任意位置", tier: "gold" },
        { id: 30, name: "顺手牵羊", description: "对手的下一次进球算作你的，选择你场上的一颗球替换", tier: "gold" },
        { id: 31, name: "传送门", description: "（随时可用，对手回合也可）将白球与你的任意球交换位置", tier: "gold" },
        { id: 32, name: "接二连三", description: "（全局可用）只要宣布本次回合内你连进2球并成功，此回合你额外获得1次击球", tier: "gold" },
        { id: 33, name: "原始人", description: "对手的下2次击球，必须在白球附近用手滚出（不可高抛或弹跳）", tier: "gold" },
        { id: 34, name: "优柔寡断", description: "（立刻使用）接下来3个回合，你放弃击球，3回合后，获得2次自由球", tier: "gold" },
        { id: 35, name: "火麟飞", description: "对手的下一次击球必须瞄准后闭眼打出", tier: "gold" },
        { id: 36, name: "一板一眼", description: "（开局可选）你场上的球减半，但对手每回合结束后，还可以再击一次球", tier: "gold" },
        
        // 棱彩阶
        { id: 37, name: "你不准win", description: "（立刻使用）将场上对方的一颗球移除，3回合后，该球将被重新放置到黑8的初始位置，你获得1次自由球，在此移除期间对手不可获得胜利(若对方只剩8号，可以移除黑8）", tier: "prismatic" },
        { id: 38, name: "预见未来", description: "每2个回合，对手必须提前告知下回合碰到哪颗球，若没碰到，则你获得1次自由球", tier: "prismatic" },
        { id: 39, name: "片叶不沾身", description: "（全局可用）使用前说明自己本杆挑战“片叶不沾身”，若此球碰到四边库且没有碰到任何球，则获得2次自由球，（此球空杆不算犯规，但若过程中碰撞到对方球，则对方获得1次自由球）", tier: "prismatic" },
        { id: 40, name: "翻袋宣言", description: "本局只要宣布本杆打翻袋成功进球，成功获得2次自由球", tier: "prismatic" },
        ...
        { id: 54, name: "遥遥领先", description: "（你的回合可用）放弃击球回合，改为主动移除自己一颗球，对手也移除自己一颗球，可用3次，不可移除你的最后一颗球", tier: "prismatic" }
    ];
